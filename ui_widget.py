...
class Ui_Widget(object):
    ...
    def retranslateUi(self, Widget):
        ...
        self.label_2.setText(QCoreApplication.translate("Widget", u"Full Name:", None))
        self.label.setText(QCoreApplication.translate("Widget", u"Occupation:", None))
